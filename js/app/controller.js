...
aiaraldea.hauteskundeak2015.controller = function (_model) {
  ...
  var init = function (_component) {
    ...
    bilakaera = aiaraldea.hauteskundeak2015.bilakaera(component, model);
    pie1 = aiaraldea.hauteskundeak2015.pie(component, model, 'Erroldaren gaineko ehunekoa');
//    pie2 = aiaraldea.hauteskundeak2015.pie(component, model, 'Zinegotziak');

    pie2 = aiaraldea.hauteskundeak2015.d3pie.create(_component, 'adg-zinegotziak');
